...
class ConfigTests(unittest.TestCase):
    def test_default_round_trip(self) -> None:
        ...
        self.assertEqual(config.steward.arbitration_provider, "gemini")
        self.assertFalse(config.steward.arbitration_visual_evidence)
        self.assertEqual(config.steward.arbitration_fallback_provider, "nvidia")
        self.assertFalse(config.steward.arbitration_fallback_visual_evidence)
    ...
    def test_steward_trusted_operator_logins_are_configurable(self) -> None:
        raw = default_config("demo")
        raw["steward"]["trusted_operator_logins"] = ["samuelalake"]
        self.assertEqual(
            parse_config(raw).steward.trusted_operator_logins,
            ("samuelalake",),
        )
