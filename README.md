...
every response so cache and other billed usage cannot escape token-only
accounting. Keep a provider-side account or key budget as the authoritative hard
stop because a response is billed before its usage can be evaluated.
